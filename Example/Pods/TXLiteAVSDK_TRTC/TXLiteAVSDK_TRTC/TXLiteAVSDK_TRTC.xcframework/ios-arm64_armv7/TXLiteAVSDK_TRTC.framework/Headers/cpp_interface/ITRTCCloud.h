 ...
 */
     ...
     * @note After calling this API to pause receiving the video stream from a specific user, simply calling the {@link startRemoteView} API will not be able to play the video from that user. You need to call {@link muteRemoteVideoStream}($NO$) or
